...
def open_image_exif_corrected(path: str) -> Image.Image:
    """Load image with EXIF Orientation applied (standalone copy)."""
...
class TributePublisherApp:
    ...
    def __init__(self, root: tk.Tk):
        ...
        tk.Label(create_form_inner, text="First Name (optional)").grid(row=11, column=0, sticky="w", **pad)
        self.first_name = tk.Entry(create_form_inner, width=44)
        self.first_name.grid(row=11, column=1, sticky="w", **pad)

        tk.Label(create_form_inner, text="State (optional)").grid(row=12, column=0, sticky="w", **pad)
        self.state = tk.Entry(create_form_inner, width=44)
        self.state.grid(row=12, column=1, sticky="w", **pad)

        tk.Label(create_form_inner, text="Email (optional)").grid(row=13, column=0, sticky="w", **pad)
        self.email = tk.Entry(create_form_inner, width=44)
        self.email.grid(row=13, column=1, sticky="w", **pad)
        ...
        self.email_sent_check.grid(row=14, column=1, sticky="w", **pad)
        ...
        tk.Label(create_form_inner, text="Tribute Message *").grid(row=6, column=0, sticky="nw", **pad)
        ...
        tk.Label(create_form_inner, text="Photo 1 (optional, recommended)").grid(row=7, column=0, sticky="w", **pad)
        ...
        tk.Label(create_form_inner, text="Photo 2 (optional)").grid(row=10, column=0, sticky="w", **pad)

        img2_row = tk.Frame(create_form_inner)
        img2_row.grid(row=10, column=1, sticky="w", **pad)
        ...
        action_row.grid(row=16, column=1, sticky="w", padx=10, pady=14)
        ...
        tk.Label(
            ...
            fg="#444"
        ).grid(row=17, column=0, columnspan=2, sticky="w", padx=10, pady=6)
