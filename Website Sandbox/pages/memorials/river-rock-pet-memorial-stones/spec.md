...
- engraved river rock
- outdoor memorial rock

## Product Features
- **Sizes**: 4", 6–8", 8–10", 10–12"
- **Material**: Natural River Rock (Real Stone)
- **Variation**: Each stone is unique in shape, color, and texture.
- **Process**: Hand-selected for engraving quality.

## Content Focus
- Explain that these are natural stones, not cast.
- Emphasize the uniqueness – no two are alike.
- Detail the size ranges available.

## Schema
- ItemList (Collection of products)
